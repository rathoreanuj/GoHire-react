  ...
  const handleSubmit = async (values, setSubmitting) => {
    ...
    try {
      ...
      const internshipData = {
        ...
        intStipend: parseFloat(values.intStipend),
        intLocation: values.intLocation.trim(),
        intDuration: parseInt(values.intDuration),
        intExperience: parseInt(values.intExperience),
        intPositions: parseInt(values.intPositions),
